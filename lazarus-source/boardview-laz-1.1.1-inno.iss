...
AppId={{87C73152-3747-491F-9853-CE99FE1F8F98}
AppName={#MyAppName}
...
OutputBaseFilename=boardview-laz-1.1.1-install
...
[Files]
Source: "C:\Users\mon-o\github\boardview\lazarus-source\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
